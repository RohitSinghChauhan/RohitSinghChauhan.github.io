            ...
            <Flex w='100%' direction='column' justifyContent='center' alignItems='center'>
                ...
                <Flex w={['100%', '80%', '80%', '80%']} mt='1.3rem' justifyContent='center' alignItems='center' boxShadow='rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px'>
                    ...
                    <Flex justifyContent='space-evenly' h={['44vh', '50vh', '50vh', '50vh']} w='50%' direction='column'>
                        ...
                        <Text as='b' fontSize={{ base: '0.9rem', lg: '1.1rem', md: '1.1rem', sm: '1.1rem' }}>Tech stack- React | HTML | CSS | Chakra-UI</Text>
                ...
                <Flex w={['100%', '80%', '80%', '80%']} mt='1.3rem' justifyContent='center' alignItems='center' boxShadow='rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px'>
                    ...
                    <Flex justifyContent='space-evenly' h={['44vh', '50vh', '50vh', '50vh']} w='50%' direction='column'>
                        <Text as='b' fontSize={{ base: '1.4rem', lg: '1.8rem', md: '1rem', sm: '1rem' }} >Hubspot</Text>
                        <Text fontSize={{ base: '1.1rem', lg: '1.2rem', md: '1.2rem', sm: '1.1rem' }}>HubSpot is a Cloud-Based CRM, HubSpot is a Software platform which is designed to help company market and sell more effectively.</Text>
                        <Text as='b' fontSize={{ base: '0.9rem', lg: '1.1rem', md: '1.1rem', sm: '1.1rem' }}>Tech stack- React | NodeJs | Express | MongoDB</Text>
                        <Flex w={['68%', '70%', '63%', '63%']} justifyContent='space-between' alignItems='center'>
                ...
                <Flex w={['100%', '80%', '80%', '80%']} mt='1.3rem' justifyContent='center' alignItems='center' boxShadow='rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px'>
                    ...
                    <Flex justifyContent='space-evenly' h={['44vh', '50vh', '50vh', '50vh']} w='50%' direction='column'>
                        ...
                        <Text as='b' fontSize={{ base: '0.9rem', lg: '1.1rem', md: '1.1rem', sm: '1.1rem' }}>Tech stack- HTML | CSS | JavaScript | DOM</Text>
                        <Flex w={['68%', '70%', '63%', '63%']} justifyContent='space-between' alignItems='center'>
