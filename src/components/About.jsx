...
const About = () => {
    return (
        <Box id="about_section" w='70vw' m='auto'>
            <Flex w='100%' h={{ lg: '50vh', md: '50vh', sm: '40vh' }} direction='column' justifyContent='center' alignItems='center'>
                <Stack spacing={{ lg: '2', md: '1', sm: '1' }} w={{ lg: '55vw', md: '95vw', sm: '90vw' }} justifyContent='center' alignItems='center'>
                    <Text as='b' color='rgb(64, 112, 244)' letterSpacing='0.15rem' fontSize={{ lg: '2.1rem', md: '2.7rem', sm: '2.6rem' }}>About</Text>
                    <Text color='blackAlpha.800' fontSize='1.9rem'>Rohit Singh</Text>
                    <Text color='blackAlpha.900' textAlign='center' fontSize={{ lg: '1rem', md: '1.2rem', sm: '1.2rem' }}>
