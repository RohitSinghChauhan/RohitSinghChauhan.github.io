        ...
        <Box id='contact_section' mt={['3rem', '5rem', '6rem', '6rem']} bgColor='blackAlpha.900'>
            <Flex h={['20vh', '24vh', '27vh', '27vh']} m='auto' w='70%' justifyContent='center' alignItems='center'>
                <Flex gap={{ base: '7', lg: '6', md: '8', sm: '20' }} m={{ base: '0', lg: "0", md: "0", sm: "auto" }} alignItems='center'>
                    <Tooltip hasArrow label='LinkedIn' display={['none', 'none', 'none', 'inline-block']} bg='gray.300' color='black'>
                    ...
                    <Tooltip hasArrow label='Github' display={['none', 'none', 'none', 'inline-block']} bg='gray.300' color='black'>
                    ...
                    <Tooltip hasArrow label='Email' display={['none', 'none', 'none', 'inline-block']} bg='gray.300' color='black'>
                    ...
                    <Tooltip hasArrow label='Call' display={['none', 'none', 'none', 'inline-block']} bg='gray.300' color='black'>
